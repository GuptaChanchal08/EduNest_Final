...
// create a subsection
export const createSubSectionJSON = async (data, token) => {
  let result = null
  const toastId = toast.loading("Loading...")
  try {
    ...
    console.log("CREATE SUB-SECTION JSON API ERROR:", error)
    toast.error(error.message)
  }
  toast.dismiss(toastId)
  return result
...
// update a subsection
export const updateSubSectionJSON = async (data, token) => {
  let result = null
  ...
  try {
    ...
    console.log("UPDATE SUB-SECTION JSON API ERROR:", error)
    toast.error(error.message)
  }
  toast.dismiss(toastId)
  return result
